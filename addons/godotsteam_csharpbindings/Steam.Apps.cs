...
public static partial class Steam
{
	...
	public static Dlc GetDLCDataByIndex(int i)
	{
		var raw = GetInstance().Call(Methods.GetDLCDataByIndex, i).AsGodotDictionary();
		var dlc = new Dlc {
			AppId = raw["app_id"].As<uint>(),
	...
	public static List<Dlc> GetDLCData()
	{
		var raw = GetInstance().Call(Methods.GetDLCData).AsGodotArray();
		return raw.Select(
